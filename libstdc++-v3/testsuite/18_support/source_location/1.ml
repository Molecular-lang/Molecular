...
int main ()
{
  ...
  VERIFY(main_sl_fi_name.ends_with("1.ml"sv));
  ...
  VERIFY(f_arg_sl_fi_name.ends_with("1.ml"sv));
  ...
  VERIFY(g_sl_fi_name.ends_with("1.ml"sv));
  ...
  VERIFY(member_main_sl_fi_name.ends_with("1.ml"sv));
  ...
  VERIFY(member_defaulted_sl_fi_name.ends_with("1.ml"sv));
  ...
  VERIFY(member_sl_fi_name.ends_with("1.ml"sv));
  ...
  VERIFY(f_sl_fi_name.ends_with("1.ml"sv));
