...
{
  /* The resource.ml machinery uses DF but the CFG isn't guaranteed to be
...
rtl_can_merge_blocks (basic_block a, basic_block b)
{
  /* If we are partitioning hot/cold basic blocks, we don't want to
     ...
     bb-reorder.ml:partition_hot_cold_basic_blocks for complete details.  */
...
/* Link the basic blocks in the correct order, compacting the basic
   ...
   is made IR-agnostic (and moved to cfganal.ml or cfg.ml while at it).  */
