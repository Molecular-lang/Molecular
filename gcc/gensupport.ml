...
/* Return true if ELEM has the attribute with the name of DEFINE_SUBST
   ...
   always generated automatically in read-rtl.ml.  */
static bool
...
/* Helper functions for define_predicate and define_special_predicate
   processing.  Shared between genrecog.ml and genpreds.ml.  */
...
/* This array gives the initial content of the predicate table.  It
   has entries for all predicates defined in recog.ml.  */
...

/* These functions allow linkage with print-rtl.ml.  Also, some generators
