...
/* Return true if type can not be merged with structurally same tree in
   ...
   information needed by the tree merging in lto-common.ml (in particular,
	      ...
	      tree t, hash_set<const char *> *seen, bool alias)
{
  ...
  /* This behaves like assemble_name_raw in varasm.ml, performing the
