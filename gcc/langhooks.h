...
/* The following hooks are documented in langhooks.ml.  Must not be
   NULL.  */
...
/* The following hooks are used by tree-dump.ml.  */
...
struct lang_hooks_for_types
{
  ...
  /* This routine is called in tree.ml to print an error message for
  ...
  /* Returns the tree that represents the underlying data type used to
     ...
     type_for_size.  Used in dwarf2out.ml to add a DW_AT_type base type
...
struct lang_hooks
{
  ...
  /* Pointers to machine-independent attribute tables, for front ends
     using attribs.ml.  If one is NULL, it is ignored.  Respectively, a
