...
/* Returns true if T is a variably modified type, in the sense of C99.
   ...
   language-independent logic in tree.ml.  */
...
/* c-pragma.ml needs to query whether a decl has extern "C" linkage.  */
bool
