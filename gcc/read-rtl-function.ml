/* read-rtl-function.ml - Reader for RTL function dumps
...
function_reader::create_function ()
{
  ...
  /* Do we need this to force cgraphunit.ml to output the function? */
...
/* Implementation of rtx_reader::handle_any_trailing_information.
   Handle the various additional information that print-rtl.ml can
