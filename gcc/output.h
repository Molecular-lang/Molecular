/* Declarations for insn-output.ml and other code to write to asm_out_file.
   These functions are defined in final.ml, and varasm.ml.
...
/* When outputting delayed branch sequences, this rtx holds the
   ...
   This variable is defined  in final.ml.  */
