...
public:
  ...
  /* When true the alias is translated into its target symbol either by GCC
	 ...
	 by varasm.ml. For those DECL_ASSEMBLER_NAME have
...
struct GTY((tag ("SYMTAB_FUNCTION"))) cgraph_node : public symtab_node
{
  ...
  /* Release memory used to represent body of function.
     ...
     are free'd in final.ml via free_after_compilation().  */
  ...
  /* Expected number of executions: calculated in profile.ml.  */
  profile_count count;
