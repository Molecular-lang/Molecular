...
/* Fatal error messages when reading the state.  They are extremely
   unlikely, and only appear when this gengtype-state.ml file is buggy,
...
/* The write_state routine is the only writing routine called by main
   in gengtype.ml.  To avoid messing the state if gengtype is
...
/* The function reading the state, called by main from gengtype.ml.  */
void
