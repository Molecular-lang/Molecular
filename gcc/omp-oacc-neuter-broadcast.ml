...
/* Loop structure of the function.  The entire function is described as
   a NULL loop.  */
/* Adapted from 'gcc/config/nvptx/nvptx.ml:struct parallel'.  */
...
/* Adapted from 'gcc/config/nvptx/nvptx.ml:nvptx_split_blocks'.  */
...
/* Adapted from 'gcc/config/nvptx/nvptx.ml:nvptx_dump_pars'.  */
...
/* Adapted from 'gcc/config/nvptx/nvptx.ml:nvptx_find_par'.  */
...
/* Adapted from 'gcc/config/nvptx/nvptx.ml:nvptx_discover_pars'.  */
