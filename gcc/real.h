...
struct GTY(()) real_value {
  ...
  All are generally used for handling cases in real.ml.  */
...
/* Target formats defined in real.ml.  */
...
/* In tree.ml: wrap up a REAL_VALUE_TYPE in a tree node.  */
