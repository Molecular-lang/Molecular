...
/* warning, error, and fatal.  These definitions are suitable for use
   ...
   of diagnostic printers, found in diagnostic.ml.  */
...
/* Given a partial pathname as input, return another pathname that
   ...
   is used by fancy_abort() to print `Internal compiler error in expr.ml'
   instead of `Internal compiler error in ../../GCC/gcc/expr.ml'.  This
