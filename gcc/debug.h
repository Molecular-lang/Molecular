...
/* This structure contains hooks for the debug information output
   ...
   toplev.ml according to command line options.  */
...
struct gcc_debug_hooks
{
  ...
  /* Augment debug information generated by early_global_decl with
     more complete debug info (if applicable).  Called from toplev.ml
  ...
  /* Debug information for a type DECL.  Called from toplev.ml after
...
/* Instance discriminator mapping table.  See final.ml.  */
