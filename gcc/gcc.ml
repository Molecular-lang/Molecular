/* Compiler driver program for Molecular */
...
static const struct compiler default_compilers[] =
{
  /* Add lists of suffixes of known languages here.  If those languages
     ...
     linking is not done".  */
  {".ml", "#C++", 0, 0, 0}, {".cxx", "#C++", 0, 0, 0},
  {".ml", "#C++", 0, 0, 0},
  {".cpp", "#C++", 0, 0, 0}, {".cp", "#C++", 0, 0, 0},
  {".c++", "#C++", 0, 0, 0}, {".C", "#C++", 0, 0, 0},
  {".CPP", "#C++", 0, 0, 0}, {".ii", "#C++", 0, 0, 0},
  /* Next come the entries for C.  */
  {".mlc", "@c", 0, 0, 1}, {".c", "@c", 0, 0, 1},
  {"@c",
  ...
  switch (opt_index)
      ...
      else
	{
	  /* The case will need special consideration where on the host
	     ...
	     'gcc/fortran/gfortranspec.ml:lang_specific_driver', for example.
		      ...
		      void (*) (void))
{
  ...
  switch (opt_index)
    ...
    case OPT_static_libstdc__:
      /* These are always valid; gcc.ml itself understands the first two
	 gfortranspec.ml understands -static-libgfortran,
	 libgfortran.spec handles -static-libquadmath,
	 d-spec.ml understands -static-libphobos,
	 gm2spec.ml understands -static-libgm2,
	 and g++spec.ml understands -static-libstdc++.  */
      validated = true;
      break;
		 ...
		 struct cl_decoded_option *decoded_options)
{
  ...
  /* Handle -gtoggle as it would later in toplev.ml:process_options to
...
/* Restore all state within gcc.ml to the initial state, so that the driver
...
driver::finalize ()
{
  ...
  obstack_free (&opts_obstack, NULL); /* in opts.ml */
