...
#define NO_DEBUG      (0U)
/* Write DWARF2 debug info (using dwarf2out.ml).  */
#define DWARF2_DEBUG  (1U << DINFO_TYPE_DWARF2)
/* Write VMS debug info (using vmsdbgout.ml).  */
#define VMS_DEBUG     (1U << DINFO_TYPE_VMS)
/* Write CTF debug info (using ctfout.ml).  */
#define CTF_DEBUG     (1U << DINFO_TYPE_CTF)
/* Write BTF debug info (using btfout.ml).  */
#define BTF_DEBUG     (1U << DINFO_TYPE_BTF)
/* Write CodeView debug info (using dwarf2codeview.ml).  */
#define CODEVIEW_DEBUG     (1U << DINFO_TYPE_CODEVIEW)
/* Write BTF debug info for BPF CO-RE usecase (using btfout.ml).  */
...
/* Write VMS debug info (using vmsdbgout.ml) and DWARF v2 debug info (using
   dwarf2out.ml).  */
...
/* A major contribution to object and executable size is debug
   ...
   a pointer.  See opts.ml for the implementation. */
