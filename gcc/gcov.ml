...
/* The functions in this file for creating and solution program flow graphs
   are very similar to functions in the gcc source file profile.ml.  In
   some places we make use of the knowledge of how profile.ml works to
...
/* Get the name of the gcov file.  The return value must be free'd.
   ...
   input: a/b/foo.ml,   output: foo.ml.gcov  */
...
solve_flow_graph (function_info *fn)
{
  ...
  /* Propagate the measured counts, this must be done in the same
     order as the code in profile.ml  */
  for (unsigned i = 0; i < fn->blocks.size (); i++)
      ...
      if (non_fake_succ == 1)
	{
      ...
      /* Sort the successor arcs into ascending dst order. profile.ml
