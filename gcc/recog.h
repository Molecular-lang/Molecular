/* Declarations for interface to insn recognizer and insn-output.ml.
...
typedef uint64_t alternative_mask;  /* Keep in sync with genattrtab.ml.  */
...
/* A table defined in insn-output.ml that give information about
...
struct insn_gen_fn
{
  ...
  // by genoutput.ml will result in static initializer functions, which defeats
