...
struct GTY((desc("0"), tag("0"),
  ...
  /* 1 in a MEM if we should keep the alias set for this mem unchanged
     ...
     1 in a CONCAT is VAL_EXPR_IS_COPIED in var-tracking.ml.
     1 in a VALUE is SP_BASED_VALUE_P in cselib.ml.
  ...
  /* In a CODE_LABEL, part of the two-bit alternate entry field.
     ...
     1 in a VALUE is SP_DERIVED_VALUE_P in cselib.ml.
  ...
  /* 1 in a REG, MEM, or CONCAT if the value is set at most once, anywhere.
     ...
     1 in a CONCAT is VAL_EXPR_IS_CLOBBERED in var-tracking.ml.
     1 in a preserved VALUE is PRESERVED_VALUE_P in cselib.ml.
  ...
  /* 1 in a MEM or ASM_OPERANDS expression if the memory reference is volatile.
     ...
     scheduling barrier.
     1 in a CONCAT is VAL_NEEDS_RESOLUTION in var-tracking.ml.
  ...
  /* At the end of RTL generation, 1 if this rtx is used.  This is used for
     ...
     1 in a CONCAT is VAL_HOLDS_TRACK_EXPR in var-tracking.ml.
     1 in a VALUE or DEBUG_EXPR is VALUE_RECURSED_INTO in var-tracking.ml.  */
  unsigned int used : 1;
  /* 1 in an INSN or a SET if this rtx is related to the call frame,
     ...
     1 in a VALUE is VALUE_CHANGED in var-tracking.ml.
     Dumped as "/f" in RTL dumps.  */
  unsigned frame_related : 1;
  /* 1 in a REG or PARALLEL that is the current function's return value.
     1 in a SYMBOL_REF for a weak symbol.
     1 in a CALL_INSN logically equivalent to ECF_PURE and DECL_PURE_P.
     1 in a CONCAT is VAL_EXPR_HAS_REVERSE in var-tracking.ml.
     1 in a VALUE or DEBUG_EXPR is NO_LOC_P in var-tracking.ml.
...
/* In jump.ml, each label contains a count of the number
...
/* In jump.ml, each JUMP_INSN can point to a label that it can jump to,
...
/* 1 if RTX is a symbol_ref that addresses a value in the file's
   tree constant pool.  This information is private to varasm.ml.  */
...
/* In insn-recog.ml (generated by genrecog).  */
...
/* There are some RTL codes that require special attention; the
   ...
   add to this list, modify special_rtx in gengenrtl.ml as well.  */
