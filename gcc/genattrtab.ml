...
/* This gen* file is unique, in that it writes out multiple files.
   ...
   Before GCC 4.8, insn-attrtab.ml was written out containing many large
   functions and tables.  This made insn-attrtab.ml _the_ bottle-neck in
...

/* Synthetic attributes used by insn-automata.ml and the scheduler.
