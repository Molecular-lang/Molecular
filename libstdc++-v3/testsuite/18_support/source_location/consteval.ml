...
int main ()
{
  ...
  static_assert(main_sl_fi_name.ends_with("consteval.ml"sv));
  ...
  static_assert(f_arg_sl_fi_name.ends_with("consteval.ml"sv));
  ...
  static_assert(g_sl_fi_name.ends_with("consteval.ml"sv));
  ...
  static_assert(member_main_sl_fi_name.ends_with("consteval.ml"sv));
  ...
  static_assert(member_defaulted_sl_fi_name.ends_with("consteval.ml"sv));
  ...
  static_assert(member_sl_fi_name.ends_with("consteval.ml"sv));
  ...
  static_assert(f_sl_fi_name.ends_with("consteval.ml"sv));
