...
#define OPTION_MASK_ISA2_AVX10_2_256 (HOST_WIDE_INT_1U << 13)
#define OPTION_MASK_ISA2_AVX10_2_512 (HOST_WIDE_INT_1U << 14)
...
enum opt_code
{
  ...
  OPT__param_x86_stlf_window_ninsns_ = 362,  /* --param=x86-stlf-window-ninsns= */
  OPT__param_x86_stv_max_visits_ = 363,      /* --param=x86-stv-max-visits= */
  ...
  OPT_list = 2012,                           /* -list */
  OPT_m128bit_long_double = 2013,            /* -m128bit-long-double */
  OPT_m16 = 2014,                            /* -m16 */
  OPT_m32 = 2015,                            /* -m32 */
  OPT_m3dnow = 2016,                         /* -m3dnow */
  OPT_m3dnowa = 2017,                        /* -m3dnowa */
  OPT_m64 = 2018,                            /* -m64 */
  OPT_m80387 = 2019,                         /* -m80387 */
  OPT_m8bit_idiv = 2020,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 2021,             /* -m96bit-long-double */
  OPT_mabi_ = 2022,                          /* -mabi= */
  OPT_mabm = 2023,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 2024,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 2025,                 /* -maddress-mode= */
  OPT_madx = 2026,                           /* -madx */
  OPT_maes = 2027,                           /* -maes */
  OPT_malign_data_ = 2028,                   /* -malign-data= */
  OPT_malign_double = 2029,                  /* -malign-double */
  OPT_malign_functions_ = 2030,              /* -malign-functions= */
  OPT_malign_jumps_ = 2031,                  /* -malign-jumps= */
  OPT_malign_loops_ = 2032,                  /* -malign-loops= */
  OPT_malign_stringops = 2033,               /* -malign-stringops */
  OPT_mamx_avx512 = 2034,                    /* -mamx-avx512 */
  OPT_mamx_bf16 = 2035,                      /* -mamx-bf16 */
  OPT_mamx_complex = 2036,                   /* -mamx-complex */
  OPT_mamx_fp16 = 2037,                      /* -mamx-fp16 */
  OPT_mamx_fp8 = 2038,                       /* -mamx-fp8 */
  OPT_mamx_int8 = 2039,                      /* -mamx-int8 */
  OPT_mamx_movrs = 2040,                     /* -mamx-movrs */
  OPT_mamx_tf32 = 2041,                      /* -mamx-tf32 */
  OPT_mamx_tile = 2042,                      /* -mamx-tile */
  OPT_mamx_transpose = 2043,                 /* -mamx-transpose */
  OPT_mandroid = 2044,                       /* -mandroid */
  OPT_mapx_features_ = 2045,                 /* -mapx-features= */
  OPT_mapx_inline_asm_use_gpr32 = 2046,      /* -mapx-inline-asm-use-gpr32 */
  OPT_mapxf = 2047,                          /* -mapxf */
  OPT_march_ = 2048,                         /* -march= */
  OPT_masm_ = 2049,                          /* -masm= */
  OPT_mavx = 2050,                           /* -mavx */
  /* OPT_mavx10_1 = 2051, */                 /* -mavx10.1 */
  OPT_mavx10_1_256 = 2052,                   /* -mavx10.1-256 */
  OPT_mavx10_1_512 = 2053,                   /* -mavx10.1-512 */
  /* OPT_mavx10_2 = 2054, */                 /* -mavx10.2 */
  OPT_mavx10_2_256 = 2055,                   /* -mavx10.2-256 */
  OPT_mavx10_2_512 = 2056,                   /* -mavx10.2-512 */
  OPT_mavx2 = 2057,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 2058,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 2059,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bf16 = 2060,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 2061,                  /* -mavx512bitalg */
  OPT_mavx512bw = 2062,                      /* -mavx512bw */
  OPT_mavx512cd = 2063,                      /* -mavx512cd */
  OPT_mavx512dq = 2064,                      /* -mavx512dq */
  OPT_mavx512f = 2065,                       /* -mavx512f */
  OPT_mavx512fp16 = 2066,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 2067,                    /* -mavx512ifma */
  OPT_mavx512vbmi = 2068,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 2069,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 2070,                      /* -mavx512vl */
  OPT_mavx512vnni = 2071,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 2072,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 2073,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 2074,                       /* -mavxifma */
  OPT_mavxneconvert = 2075,                  /* -mavxneconvert */
  OPT_mavxvnni = 2076,                       /* -mavxvnni */
  OPT_mavxvnniint16 = 2077,                  /* -mavxvnniint16 */
  OPT_mavxvnniint8 = 2078,                   /* -mavxvnniint8 */
  OPT_mbionic = 2079,                        /* -mbionic */
  OPT_mbmi = 2080,                           /* -mbmi */
  OPT_mbmi2 = 2081,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 2082,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 2083,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 2084,                    /* -mcet-switch */
  OPT_mcld = 2085,                           /* -mcld */
  OPT_mcldemote = 2086,                      /* -mcldemote */
  OPT_mclflushopt = 2087,                    /* -mclflushopt */
  OPT_mclwb = 2088,                          /* -mclwb */
  OPT_mclzero = 2089,                        /* -mclzero */
  OPT_mcmodel_ = 2090,                       /* -mcmodel= */
  OPT_mcmpccxadd = 2091,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 2092, */                    /* -mcpu= */
  OPT_mcrc32 = 2093,                         /* -mcrc32 */
  OPT_mcx16 = 2094,                          /* -mcx16 */
  OPT_mdaz_ftz = 2095,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 2096,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2097,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 2098,            /* -mdump-tune-features */
  OPT_menqcmd = 2099,                        /* -menqcmd */
  OPT_mevex512 = 2100,                       /* -mevex512 */
  OPT_mf16c = 2101,                          /* -mf16c */
  OPT_mfancy_math_387 = 2102,                /* -mfancy-math-387 */
  OPT_mfentry = 2103,                        /* -mfentry */
  OPT_mfentry_name_ = 2104,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2105,               /* -mfentry-section= */
  OPT_mfma = 2106,                           /* -mfma */
  OPT_mfma4 = 2107,                          /* -mfma4 */
  OPT_mforce_drap = 2108,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2109,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2110,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2111,                       /* -mfpmath= */
  OPT_mfsgsbase = 2112,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2113,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2114, */              /* -mfused-madd */
  OPT_mfxsr = 2115,                          /* -mfxsr */
  /* OPT_mgather = 2116, */                  /* -mgather */
  OPT_mgeneral_regs_only = 2117,             /* -mgeneral-regs-only */
  OPT_mgfni = 2118,                          /* -mgfni */
  OPT_mglibc = 2119,                         /* -mglibc */
  OPT_mhard_float = 2120,                    /* -mhard-float */
  OPT_mharden_sls_ = 2121,                   /* -mharden-sls= */
  OPT_mhle = 2122,                           /* -mhle */
  OPT_mhreset = 2123,                        /* -mhreset */
  OPT_miamcu = 2124,                         /* -miamcu */
  OPT_mieee_fp = 2125,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2126,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2127,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2128,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2129,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2130,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2131,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2132,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2133, */            /* -mintel-syntax */
  OPT_mkl = 2134,                            /* -mkl */
  OPT_mlam_ = 2135,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2136,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2137,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2138,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2139,                /* -mlong-double-80 */
  OPT_mlwp = 2140,                           /* -mlwp */
  OPT_mlzcnt = 2141,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2142,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2143,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2144,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2145,                  /* -mmitigate-rop */
  OPT_mmmx = 2146,                           /* -mmmx */
  OPT_mmovbe = 2147,                         /* -mmovbe */
  OPT_mmovdir64b = 2148,                     /* -mmovdir64b */
  OPT_mmovdiri = 2149,                       /* -mmovdiri */
  OPT_mmove_max_ = 2150,                     /* -mmove-max= */
  OPT_mmovrs = 2151,                         /* -mmovrs */
  OPT_mmpx = 2152,                           /* -mmpx */
  OPT_mms_bitfields = 2153,                  /* -mms-bitfields */
  OPT_mmusl = 2154,                          /* -mmusl */
  OPT_mmwait = 2155,                         /* -mmwait */
  OPT_mmwaitx = 2156,                        /* -mmwaitx */
  OPT_mneeded = 2157,                        /* -mneeded */
  OPT_mno_align_stringops = 2158,            /* -mno-align-stringops */
  OPT_mno_default = 2159,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2160,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2161,                  /* -mno-push-args */
  OPT_mno_red_zone = 2162,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2163,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2164,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2165,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2166,       /* -momit-leaf-frame-pointer */
  OPT_mpartial_vector_fp_math = 2167,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2168,                          /* -mpc32 */
  OPT_mpc64 = 2169,                          /* -mpc64 */
  OPT_mpc80 = 2170,                          /* -mpc80 */
  OPT_mpclmul = 2171,                        /* -mpclmul */
  OPT_mpcommit = 2172,                       /* -mpcommit */
  OPT_mpconfig = 2173,                       /* -mpconfig */
  OPT_mpku = 2174,                           /* -mpku */
  OPT_mpopcnt = 2175,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2176, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2177,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2178,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2179,                     /* -mprefetchi */
  OPT_mprfchw = 2180,                        /* -mprfchw */
  OPT_mptwrite = 2181,                       /* -mptwrite */
  OPT_mpush_args = 2182,                     /* -mpush-args */
  OPT_mraoint = 2183,                        /* -mraoint */
  OPT_mrdpid = 2184,                         /* -mrdpid */
  OPT_mrdrnd = 2185,                         /* -mrdrnd */
  OPT_mrdseed = 2186,                        /* -mrdseed */
  OPT_mrecip = 2187,                         /* -mrecip */
  OPT_mrecip_ = 2188,                        /* -mrecip= */
  OPT_mrecord_mcount = 2189,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2190,                 /* -mrecord-return */
  OPT_mred_zone = 2191,                      /* -mred-zone */
  OPT_mregparm_ = 2192,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2193,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2194,                           /* -mrtd */
  OPT_mrtm = 2195,                           /* -mrtm */
  OPT_msahf = 2196,                          /* -msahf */
  /* OPT_mscatter = 2197, */                 /* -mscatter */
  OPT_mserialize = 2198,                     /* -mserialize */
  OPT_msgx = 2199,                           /* -msgx */
  OPT_msha = 2200,                           /* -msha */
  OPT_msha512 = 2201,                        /* -msha512 */
  OPT_mshstk = 2202,                         /* -mshstk */
  OPT_mskip_rax_setup = 2203,                /* -mskip-rax-setup */
  OPT_msm3 = 2204,                           /* -msm3 */
  OPT_msm4 = 2205,                           /* -msm4 */
  OPT_msoft_float = 2206,                    /* -msoft-float */
  OPT_msse = 2207,                           /* -msse */
  OPT_msse2 = 2208,                          /* -msse2 */
  OPT_msse2avx = 2209,                       /* -msse2avx */
  OPT_msse3 = 2210,                          /* -msse3 */
  OPT_msse4 = 2211,                          /* -msse4 */
  OPT_msse4_1 = 2212,                        /* -msse4.1 */
  OPT_msse4_2 = 2213,                        /* -msse4.2 */
  OPT_msse4a = 2214,                         /* -msse4a */
  /* OPT_msse5 = 2215, */                    /* -msse5 */
  OPT_msseregparm = 2216,                    /* -msseregparm */
  OPT_mssse3 = 2217,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2218,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2219, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2220,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2221, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2222,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2223,                  /* -mstackrealign */
  OPT_mstore_max_ = 2224,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2225,            /* -mstringop-strategy= */
  OPT_mstv = 2226,                           /* -mstv */
  OPT_mtbm = 2227,                           /* -mtbm */
  OPT_mtls_dialect_ = 2228,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2229,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2230,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2231,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2232,                         /* -mtune= */
  OPT_muclibc = 2233,                        /* -muclibc */
  OPT_muintr = 2234,                         /* -muintr */
  OPT_munroll_only_small_loops = 2235,       /* -munroll-only-small-loops */
  OPT_musermsr = 2236,                       /* -musermsr */
  OPT_mvaes = 2237,                          /* -mvaes */
  OPT_mveclibabi_ = 2238,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2239,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2240,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2241,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2242,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2243,                      /* -mwbnoinvd */
  OPT_mwidekl = 2244,                        /* -mwidekl */
  OPT_mx32 = 2245,                           /* -mx32 */
  OPT_mxop = 2246,                           /* -mxop */
  OPT_mxsave = 2247,                         /* -mxsave */
  OPT_mxsavec = 2248,                        /* -mxsavec */
  OPT_mxsaveopt = 2249,                      /* -mxsaveopt */
  OPT_mxsaves = 2250,                        /* -mxsaves */
  OPT_n = 2251,                              /* -n */
  OPT_name_sort = 2252,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2253,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2254,              /* -no-integrated-cpp */
  OPT_no_pie = 2255,                         /* -no-pie */
  OPT_nocpp = 2256,                          /* -nocpp */
  OPT_nodefaultlibs = 2257,                  /* -nodefaultlibs */
  OPT_nolibc = 2258,                         /* -nolibc */
  OPT_nophoboslib = 2259,                    /* -nophoboslib */
  OPT_nostartfiles = 2260,                   /* -nostartfiles */
  OPT_nostdinc = 2261,                       /* -nostdinc */
  OPT_nostdinc__ = 2262,                     /* -nostdinc++ */
  OPT_nostdlib = 2263,                       /* -nostdlib */
  OPT_nostdlib__ = 2264,                     /* -nostdlib++ */
  OPT_o = 2265,                              /* -o */
  OPT_objects = 2266,                        /* -objects */
  OPT_p = 2267,                              /* -p */
  OPT_pass_exit_codes = 2268,                /* -pass-exit-codes */
  /* OPT_pedantic = 2269, */                 /* -pedantic */
  OPT_pedantic_errors = 2270,                /* -pedantic-errors */
  OPT_pg = 2271,                             /* -pg */
  OPT_pie = 2272,                            /* -pie */
  OPT_pipe = 2273,                           /* -pipe */
  OPT_posix = 2274,                          /* -posix */
  OPT_print_file_name_ = 2275,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2276,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2277,          /* -print-multi-directory */
  OPT_print_multi_lib = 2278,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2279,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2280,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2281,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2282,               /* -print-prog-name= */
  OPT_print_search_dirs = 2283,              /* -print-search-dirs */
  OPT_print_sysroot = 2284,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2285,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2286,                    /* -print-value */
  OPT_profile = 2287,                        /* -profile */
  OPT_pthread = 2288,                        /* -pthread */
  OPT_quiet = 2289,                          /* -quiet */
  OPT_r = 2290,                              /* -r */
  OPT_rdynamic = 2291,                       /* -rdynamic */
  OPT_remap = 2292,                          /* -remap */
  OPT_reverse_sort = 2293,                   /* -reverse-sort */
  OPT_s = 2294,                              /* -s */
  OPT_save_temps = 2295,                     /* -save-temps */
  OPT_save_temps_ = 2296,                    /* -save-temps= */
  OPT_shared = 2297,                         /* -shared */
  OPT_shared_libgcc = 2298,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2299,               /* -shared-libphobos */
  OPT_size_sort = 2300,                      /* -size-sort */
  /* OPT_specs = 2301, */                    /* -specs */
  OPT_specs_ = 2302,                         /* -specs= */
  OPT_static = 2303,                         /* -static */
  OPT_static_libasan = 2304,                 /* -static-libasan */
  OPT_static_libgcc = 2305,                  /* -static-libgcc */
  OPT_static_libgfortran = 2306,             /* -static-libgfortran */
  OPT_static_libgm2 = 2307,                  /* -static-libgm2 */
  OPT_static_libgo = 2308,                   /* -static-libgo */
  OPT_static_libhwasan = 2309,               /* -static-libhwasan */
  OPT_static_liblsan = 2310,                 /* -static-liblsan */
  OPT_static_libmpx = 2311,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2312,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2313,               /* -static-libphobos */
  OPT_static_libquadmath = 2314,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2315,               /* -static-libstdc++ */
  OPT_static_libtsan = 2316,                 /* -static-libtsan */
  OPT_static_libubsan = 2317,                /* -static-libubsan */
  OPT_static_pie = 2318,                     /* -static-pie */
  /* OPT_std_c__03 = 2319, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2320, */                /* -std=c++0x */
  OPT_std_c__11 = 2321,                      /* -std=c++11 */
  OPT_std_c__14 = 2322,                      /* -std=c++14 */
  OPT_std_c__17 = 2323,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2324, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2325, */                /* -std=c++1z */
  OPT_std_c__20 = 2326,                      /* -std=c++20 */
  OPT_std_c__23 = 2327,                      /* -std=c++23 */
  OPT_std_c__26 = 2328,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2329, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2330, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2331, */                /* -std=c++2c */
  OPT_std_c__98 = 2332,                      /* -std=c++98 */
  OPT_std_c11 = 2333,                        /* -std=c11 */
  OPT_std_c17 = 2334,                        /* -std=c17 */
  /* OPT_std_c18 = 2335, */                  /* -std=c18 */
  /* OPT_std_c1x = 2336, */                  /* -std=c1x */
  OPT_std_c23 = 2337,                        /* -std=c23 */
  /* OPT_std_c2x = 2338, */                  /* -std=c2x */
  OPT_std_c2y = 2339,                        /* -std=c2y */
  /* OPT_std_c89 = 2340, */                  /* -std=c89 */
  OPT_std_c90 = 2341,                        /* -std=c90 */
  OPT_std_c99 = 2342,                        /* -std=c99 */
  /* OPT_std_c9x = 2343, */                  /* -std=c9x */
  OPT_std_f2003 = 2344,                      /* -std=f2003 */
  OPT_std_f2008 = 2345,                      /* -std=f2008 */
  OPT_std_f2008ts = 2346,                    /* -std=f2008ts */
  OPT_std_f2018 = 2347,                      /* -std=f2018 */
  OPT_std_f2023 = 2348,                      /* -std=f2023 */
  OPT_std_f202y = 2349,                      /* -std=f202y */
  OPT_std_f95 = 2350,                        /* -std=f95 */
  OPT_std_gnu = 2351,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2352, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2353, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2354,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2355,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2356,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2357, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2358, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2359,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2360,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2361,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2362, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2363, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2364, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2365,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2366,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2367,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2368, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2369, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2370,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2371, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2372,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2373, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2374,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2375,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2376, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2377, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2378,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2379, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2380, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2381, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2382, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2383, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2384, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2385,                     /* -std=legacy */
  OPT_stdlib_ = 2386,                        /* -stdlib= */
  OPT_symbol_ = 2387,                        /* -symbol= */
  OPT_symbolic = 2388,                       /* -symbolic */
  OPT_t = 2389,                              /* -t */
  OPT_time = 2390,                           /* -time */
  OPT_time_ = 2391,                          /* -time= */
  OPT_tno_android_cc = 2392,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2393,                 /* -tno-android-ld */
  OPT_traditional = 2394,                    /* -traditional */
  OPT_traditional_cpp = 2395,                /* -traditional-cpp */
  OPT_tree_stats = 2396,                     /* -tree-stats */
  OPT_trigraphs = 2397,                      /* -trigraphs */
  OPT_truncate = 2398,                       /* -truncate */
  OPT_type_stats = 2399,                     /* -type-stats */
  OPT_u = 2400,                              /* -u */
  OPT_undef = 2401,                          /* -undef */
  OPT_v = 2402,                              /* -v */
  OPT_version = 2403,                        /* -version */
  OPT_w = 2404,                              /* -w */
  OPT_wrapper = 2405,                        /* -wrapper */
  OPT_x = 2406,                              /* -x */
  OPT_z = 2407,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
