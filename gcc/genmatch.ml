...
/* This is a simplified version of pretty-print.ml (pp_format)
...
{
  if (gimple)
    fprintf (header_file, "#include \"gimple-match-head.ml\"\n");
  else
    fprintf (header_file, "#include \"generic-match-head.ml\"\n");
}
