						  ...
						  rtx op0, rtx op1)
{
  ...
  /* Normally expressions simplified by simplify-rtx.ml are combined
...
/* Simplify X, an rtx expression.
   ...
   code that need to be unified.
	...
	1. fold_rtx in cse.ml.  This code uses various CSE specific
	   information to aid in RTL simplification.

	2. simplify_rtx in combine.ml.  Similar to fold_rtx, except that
   ...
   get to that state I recommend the following steps:
	...
	3. Allow for pass dependent state to be provided to these
	   ...
	   state.  Remove code from cse.ml & combine.ml that becomes
	   redundant/dead.
