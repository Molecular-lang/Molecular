/* Pretty formatting of GENERIC trees in C syntax.
   ...
   Adapted from c-pretty-print.ml by Diego Novillo <dnovillo@redhat.com>
  ...
  switch (code)
	  ...
	  && ! (flags & TDF_GIMPLE))
	{
	  /* In the case of a pointer, one may want to divide by the
	     ...
	     case, the 5 is multiplied by sizeof (int) in c-common.ml
    ...
    case OBJ_TYPE_REF:
	 ...
	 libstdc++-prettyprinters/shared_ptr.ml with and without -g,
