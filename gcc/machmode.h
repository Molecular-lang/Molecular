...
/* The MACHINE_MODE_BITSIZE should be exactly aligned with the type of the
   machine_mode array in the machmode.h and genmodes.ml.  For example as below.
   +------------------------+-------+
...
/* Target-dependent machine mode initialization - in insn-modes.ml.  */
...
/* This is also in tree.h.  genmodes.ml guarantees the're sorted from
